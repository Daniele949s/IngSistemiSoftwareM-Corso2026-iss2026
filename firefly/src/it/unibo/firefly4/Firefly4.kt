...
class Firefly4 ( name: String, scope: CoroutineScope, isconfined: Boolean=false, isdynamic: Boolean=false ) : 
	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		//IF actor.withobj !== null val actor.withobj.name� = actor.withobj.method�ENDIF
		 var X = 8; var Y = 8; var Sync = false; var T = 1000L  
		return { //this:ActionBasciFsm
				...
				state("flash") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t010",targetState="flash",cond=whenTimeout("local_tout_"+name+"_flash"))   
					transition(edgeName="t011",targetState="flash",cond=whenDispatch("sync_on"))
					transition(edgeName="t012",targetState="flash",cond=whenDispatch("sync_off"))
				}	 
			}
		}
} 
