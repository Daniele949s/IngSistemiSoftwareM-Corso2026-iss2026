...
class Firefly5 ( name: String, scope: CoroutineScope, isconfined: Boolean=false, isdynamic: Boolean=false ) : 
	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		//IF actor.withobj !== null val actor.withobj.name� = actor.withobj.method�ENDIF
		 var X = 9; var Y = 9; var Sync = false; var T = 1000L  
		return { //this:ActionBasciFsm
				...
				state("flash") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t013",targetState="flash",cond=whenTimeout("local_tout_"+name+"_flash"))   
					transition(edgeName="t014",targetState="flash",cond=whenDispatch("sync_on"))
					transition(edgeName="t015",targetState="flash",cond=whenDispatch("sync_off"))
				}	 
			}
		}
} 
