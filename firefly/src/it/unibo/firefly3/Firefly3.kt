		...
		return { //this:ActionBasciFsm
				...
				state("random_flash") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t011",targetState="random_flash",cond=whenTimeout("local_tout_"+name+"_random_flash"))   
					transition(edgeName="t012",targetState="sync_flash",cond=whenDispatch("sync_on"))
				}	 
				state("sync_flash") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t113",targetState="sync_flash",cond=whenTimeout("local_tout_"+name+"_sync_flash"))   
					transition(edgeName="t114",targetState="s0",cond=whenDispatch("sync_off"))
				}	 
			}
		}
} 
