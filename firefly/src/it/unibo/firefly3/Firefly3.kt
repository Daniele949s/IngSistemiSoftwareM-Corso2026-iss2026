...
class Firefly3 ( name: String, scope: CoroutineScope, isconfined: Boolean=false, isdynamic: Boolean=false ) : 
	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		//IF actor.withobj !== null val actor.withobj.name� = actor.withobj.method�ENDIF
		 var X = 1; var Y = 1; var Sync = false; var T = 1000L  
		return { //this:ActionBasciFsm
				...
				state("flash") { //this:State
					...
					transition(edgeName="t08",targetState="flash",cond=whenDispatch("sync_on"))
					transition(edgeName="t09",targetState="flash",cond=whenDispatch("sync_off"))
				}	 
			}
		}
} 
